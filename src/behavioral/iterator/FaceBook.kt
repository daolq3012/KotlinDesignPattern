 ...
 */
class FaceBook(var profiles: List<Profile>?) : SocialNetwork {
    ...
    override fun getFriendsIterator(profileEmail: String): ProfileIterator {
        return FacebookIterator(this, type = "friends", email = profileEmail)
    }

    override fun getCoworkersIterator(profileEmail: String): ProfileIterator {
        return FacebookIterator(this, type = "coworkers", email = profileEmail)
    }
...
class FacebookIterator(val faceBook: FaceBook, val type: String, val email: String) : ProfileIterator {
